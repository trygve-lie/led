...
var ws = new WebSocket('ws://' + window.location.host + '/edit');
...
doc.whenReady(function () {
	...
	var editor = new Quill('#editor', {
		modules: {
			...
			'authorship'  : {authorId: userId, enabled: true, color:  'rgb(255, 0, 255)', button: document.getElementById('authors')},
			'link-tooltip': true
		},
		theme  : 'snow'
	});
...
*/
	...
	editor.on('selection-change', function (range) {
		if (range) {
			var c = hexToRgb(document.getElementById('cursor-colour').value);
